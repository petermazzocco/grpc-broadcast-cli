...
const file_broadcast_proto_rawDesc = "" +
	"\n" +
	"\x0fbroadcast.proto\x12\tbroadcast\"*\n" +
	"\x0eMessageRequest\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"+\n" +
	"\x0fMessageResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2S\n" +
	"\tBroadcast\x12F\n" +
	"\vSendMessage\x12\x19.broadcast.MessageRequest\x1a\x1a.broadcast.MessageResponse\"\x00B\rZ\v./broadcastb\x06proto3"
...
var file_broadcast_proto_goTypes = []any{
	(*MessageRequest)(nil),  // 0: broadcast.MessageRequest
	(*MessageResponse)(nil), // 1: broadcast.MessageResponse
}
var file_broadcast_proto_depIdxs = []int32{
	0, // 0: broadcast.Broadcast.SendMessage:input_type -> broadcast.MessageRequest
	1, // 1: broadcast.Broadcast.SendMessage:output_type -> broadcast.MessageResponse
